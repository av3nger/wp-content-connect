<?php
/**
 * Register REST API endpoints for adding multiple new relationship.
 *
 * @since 1.4.1
 *
...
/**
 * AddRelationships class.
 */
class AddRelationships extends API {
	/**
	 * Endpoint name.
	 *
	 * @since 1.4.1
	 * @var string
	 */
	public string $route = 'create-relationships';
